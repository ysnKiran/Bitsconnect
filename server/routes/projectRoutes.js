...
router.get(
  "/getApplicationsByProject/:project_id",
  ProjectController.getApplicationsByProject
);
router.get(
  "/getSelectedApplicationsByProject/:project_id",
  ProjectController.getSelectedApplicationsByProject
);
...
router.get("/project/:project_id", ProjectController.getProjectByID);
